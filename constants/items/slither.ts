...
export const SLITHER_SKINS_CATALOG: SlitherSkin[] = [
    ...
    // --- COLLECTION WORLD TOUR (Couleurs optimisées pour le néon) ---
    { id: 'ss_flag_fr', name: 'France', price: 500, primaryColor: '#0066ff', secondaryColor: '#FFFFFF', glowColor: '#FFFFFF', pattern: 'flag', flagColors: ['#0066ff', '#FFFFFF', '#ff0033'], rarity: 'RARE', description: 'Bleu, Blanc, Rouge. Allez les Bleus !' },
    { id: 'ss_flag_it', name: 'Italie', price: 500, primaryColor: '#00ff44', secondaryColor: '#FFFFFF', glowColor: '#FFFFFF', pattern: 'flag', flagColors: ['#00ff44', '#FFFFFF', '#ff0033'], rarity: 'RARE', description: 'Forza Italia sur la grille.' },
    { id: 'ss_flag_de', name: 'Allemagne', price: 500, primaryColor: '#111111', secondaryColor: '#ff0000', glowColor: '#ffcc00', pattern: 'flag', flagColors: ['#111111', '#ff0000', '#ffcc00'], rarity: 'RARE', description: 'Efficacité et précision germanique.' },
    { id: 'ss_flag_br', name: 'Brésil', price: 500, primaryColor: '#00ff00', secondaryColor: '#ffff00', glowColor: '#0066ff', pattern: 'flag', flagColors: ['#00ff00', '#ffff00', '#0066ff'], rarity: 'RARE', description: 'Le rythme de la samba dans chaque mouvement.' },
    { id: 'ss_flag_us', name: 'USA', price: 500, primaryColor: '#ff0033', secondaryColor: '#FFFFFF', glowColor: '#0044ff', pattern: 'flag', flagColors: ['#0044ff', '#FFFFFF', '#ff0033'], rarity: 'RARE', description: 'The Stars and Stripes.' },
    { id: 'ss_flag_jp', name: 'Japon', price: 500, primaryColor: '#FFFFFF', secondaryColor: '#ff0033', glowColor: '#ff0033', pattern: 'flag', flagColors: ['#FFFFFF', '#FFFFFF', '#ff0033', '#FFFFFF', '#FFFFFF'], rarity: 'RARE', description: 'L\'élégance du soleil levant.' },
    { id: 'ss_flag_es', name: 'Espagne', price: 500, primaryColor: '#ff0033', secondaryColor: '#ffff00', glowColor: '#ff0033', pattern: 'flag', flagColors: ['#ff0033', '#ffff00', '#ff0033'], rarity: 'RARE', description: 'La passion du néon ibérique.' },
    { id: 'ss_flag_be', name: 'Belgique', price: 500, primaryColor: '#111111', secondaryColor: '#ffff00', glowColor: '#ff0033', pattern: 'flag', flagColors: ['#111111', '#ffff00', '#ff0033'], rarity: 'RARE', description: 'L\'union fait la force sur le serveur.' },
