...
export const LeaderboardWidget: React.FC<LeaderboardWidgetProps> = ({ highScores, onlineUsers, language }) => {
    ...
    return (
        <>
            ...
            <div className={`w-full bg-black/60 border border-white/10 rounded-xl backdrop-blur-md transition-all duration-300 shadow-xl relative overflow-hidden ${showScores ? 'z-20 border-yellow-400/50 shadow-[0_0_35px_rgba(250,204,21,0.2)]' : 'z-10 hover:border-yellow-400/30'}`}>
                <button 
