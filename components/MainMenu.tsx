...
const GAMES_CONFIG = [
    ...
    { id: 'tetris', category: 'ARCADE', name: 'NEON BLOCKS', icon: TetrisIcon, color: 'text-cyan-400', bg: 'bg-cyan-900/20', border: 'border-cyan-500/30', hoverBorder: 'hover:border-cyan-400', shadow: 'hover:shadow-[0_0_20px_rgba(34,211,238,0.3)]', glow: 'rgba(34,211,238,0.8)', badges: { solo: true, online: false, vs: false, new: false }, reward: 'GAINS' },
...
const LEADERBOARD_GAMES = [
    ...
    { id: 'tetris', label: 'NEON BLOCKS', unit: '', type: 'high', color: 'text-neon-blue' },
