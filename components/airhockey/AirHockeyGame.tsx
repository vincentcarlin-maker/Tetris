...
import { Home, RefreshCw, Trophy, Coins, Play, HelpCircle, Users, Globe, Pause, Loader2, Wifi, Search } from 'lucide-react';
            ...
            <div className="h-full w-full flex flex-col items-center bg-black/20 relative overflow-y-auto text-white font-sans p-2">
                ...
                <div className="w-full max-w-lg flex items-center justify-between z-10 mb-4 shrink-0">
                    ...
                    <div className="flex flex-col items-center">
                        <h1 className="text-3xl font-black italic text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-300 drop-shadow-[0_0_10px_rgba(34,211,238,0.5)]">AIR HOCKEY</h1>
                        <span className="text-[10px] font-bold text-cyan-400/80 tracking-[0.3em] uppercase">Salon Multijoueur</span>
                    </div>
