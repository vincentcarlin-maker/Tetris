...
import { ShopGroup, ShopCategory } from './shop/types';
import { ShopHeader } from './shop/components/ShopHeader';
import { CategoryGrid } from './shop/components/CategoryGrid';
import { ItemGroups } from './shop/components/ItemGroups';
...
export const Shop: React.FC<ShopContainerProps> = ({ onBack }) => {
    ...
    return (
        <div className="flex flex-col h-full w-full bg-[#05050a] relative overflow-hidden font-sans text-white">
            ...
            <div className="w-full max-w-4xl mx-auto flex items-center justify-between p-4 z-20 shrink-0" style={{ paddingTop: 'calc(0.5rem + env(safe-area-inset-top))' }}>
                <ShopHeader 
